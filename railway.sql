...
CREATE TABLE IF NOT EXISTS `tickets` (
  ...
  't_class' varchar(20) DEFAULT NULL AUTO_INCREMENT,
  UNIQUE KEY `PNR` (`PNR`)
...
INSERT INTO `tickets` (`PNR`, `t_status`, `t_fare`, `p_id`,'t_class') VALUES
(8056124359, 'Confirmed', 650, 5 ,NULL ),
(8851599875, 'Waiting', 540, 1,NULL);
